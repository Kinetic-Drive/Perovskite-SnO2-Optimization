...
class Data_Processor():
    ...
    #Drops all "bad" pixels from a device with a method decided by a string input mode. if mode is "Average", every pixel in a device below its average is dropped
    ...
    def Drop_Bad_Pixels(self, mode):
        ...
        for device in devices_list:
            ...
            if mode == "Average":
                ...
                bad_pixels = pixels[pixels[self.par_to_optimize] <= 0.5 *av_opt ]
            elif mode == "Max":
